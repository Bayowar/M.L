...
```
    ...
    Shape of merged DataFrame: (5279434, 14)
...
```
    ...
    <class 'pandas.core.frame.DataFrame'>
    Index: 4941862 entries, 6 to 5279433
    Data columns (total 13 columns):
     #   Column                      Non-Null Count    Dtype 
    ---  ------                      --------------    ----- 
     0   age                         4941862 non-null  int64 
     1   race_eth                    4941862 non-null  int64 
     2   first_degree_hx             4941862 non-null  int64 
     3   age_menarche                4941862 non-null  int64 
     4   age_first_birth             4941862 non-null  int64 
     5   current_hrt                 4941862 non-null  int64 
     6   menopaus                    4941862 non-null  int64 
     7   breast_cancer_history       4941862 non-null  int64 
     8   density_c                   4941862 non-null  object
     9   resfnl_c3                   4941862 non-null  int64 
     10  cancscrfu1yr_c              4941862 non-null  int64 
     11  stage_advanced              4941862 non-null  int64 
     12  riskBCSC_v2_5y_cat_numeric  4941862 non-null  int64 
...
```
    ...
    Count of participants who have not-confirmed Cancer in the dataset: 3648525
    Count of participants who have confirmed Cancer in the dataset: 1293337
...
```
    ...
    Total count in the column: 4941862
    Count of White participants: 1463565
    Count of Black participants: 897747
    Count of Asian pacific participants: 755716
    Count of Native american participants: 185490
    Count of Hispanic participants: 765276
    Count of Other/Mixed participants: 442263
    Count of Persons indentified as Unknown in ethnic background: 431805
    Percentage of White: 29.62
    Percentage of Black: 18.17
...
```
    ...
    Number of White Non-Hispanic with confirmed cancer: 382683
    Number of Black Non-Hispanic with confirmed cancer: 235021
    Number of Hispanic with confirmed cancer: 199889
    Number of Asian/Pacific with confirmed cancer: 198325
    Number of Nativeamerican with confirmed cancer: 48558
    ...
    [116002 rows x 13 columns]
    Number of unknown_ethnicity with confirmed cancer: 112859
    Percentage of white with cancer: 29.59
    Percentage of black with cancer: 18.17
    Percentage of hispanic with cancer: 15.46
    Percentage of asian/pacific with cancer: 15.33
    Percentage of nativeamerican with cancer: 3.75
    Percentage of other_mixed ethnicity with cancer: 8.97
    Percentage of unknown_ethnicity with cancer: 8.73
...
```
    ...
    Count of participants who have not-confirmed history in the dataset: 2425264
    Count of participants who have confirmed history in the dataset: 1075077
...
```
    ...
    2                   density_c           2473.721712   0.000000e+00
    4              cancscrfu1yr_c          72040.554957   0.000000e+00
    5  riskBCSC_v2_5y_cat_numeric           2193.385469   0.000000e+00
    0                         age            535.362184  2.018502e-112
    3                   resfnl_c3             46.276632   1.026813e-11
    1                    race_eth              1.391849   9.663524e-01
...
```
    ...
    Date:                Thu, 01 May 2025   Pseudo R-squ.:                  0.2917
    Time:                        20:51:35   Log-Likelihood:            -1.2216e+05
    converged:                       True   LL-Null:                   -1.7248e+05
    Covariance Type:            nonrobust   LLR p-value:                     0.000
    ==============================================================================================
                                     coef    std err          z      P>|z|      [0.025      0.975]
    ----------------------------------------------------------------------------------------------
    const                        -15.1454      5.158     -2.936      0.003     -25.255      -5.035
    age                            0.0169      0.003      5.639      0.000       0.011       0.023
    race_eth                       0.0016      0.002      0.804      0.421      -0.002       0.005
    density_c                      0.1106      0.005     21.394      0.000       0.100       0.121
    resfnl_c3                     -0.1478      0.010    -15.446      0.000      -0.167      -0.129
    cancscrfu1yr_c                14.7141      5.158      2.853      0.004       4.604      24.824
    riskBCSC_v2_5y_cat_numeric    -0.0915      0.004    -22.225      0.000      -0.100      -0.083
    ==============================================================================================
    
    Possibly complete quasi-separation: A fraction 0.40 of observations can be
    perfectly predicted. This might indicate that there is complete
    quasi-separation. In this case some parameters will not be identified.
    Accuracy: 0.7364366666666666
...
```
    ...
    0                            age  8.448239
    1                       race_eth  2.729874
    2                      resfnl_c3  1.958519
    3                 cancscrfu1yr_c  2.515034
    4                    density_c_2  2.311183
    5                    density_c_3  2.538352
    6                    density_c_4  2.509728
    7   riskBCSC_v2_5y_cat_numeric_1  2.395557
    8   riskBCSC_v2_5y_cat_numeric_2  2.416151
    9   riskBCSC_v2_5y_cat_numeric_3  2.308976
    10  riskBCSC_v2_5y_cat_numeric_4  2.107153
...
```
    ...
    Classification Report for Random Forest:
           ...
           No CA       1.00      0.65      0.79     23466
              CA       0.74      1.00      0.85     23656
    
        accuracy                           0.83     47122
       macro avg       0.87      0.83      0.82     47122
    weighted avg       0.87      0.83      0.82     47122
...
```
    ...
    MCC (Random Forest): 0.6951402743808465
...
```
    ...
    array([0.10271024, 0.01316449, 0.06470723, 0.01749471, 0.71108131,
           0.09084203])
...
```
    ...
    <matplotlib.legend.Legend at 0x30fd94170>
...
#sk-container-id-2 a.estimator_doc_link.fitted:hover {
  ...
  background-color: var(--sklearn-color-fitted-level-3);
             ...
             param_grid={&#x27;bootstrap&#x27;: [True, False], &#x27;max_features&#x27;: [2, 3, 4],
                         &#x27;n_estimators&#x27;: [84, 120, 170, 300],
                         &#x27;oob_score&#x27;: [True, False]})</pre></div> </div></div><div class="sk-parallel"><div class="sk-parallel-item"><div class="sk-item"><div class="sk-label-container"><div class="sk-label fitted sk-toggleable"><input class="sk-toggleable__control sk-hidden--visually" id="sk-estimator-id-3" type="checkbox" ><label for="sk-estimator-id-3" class="sk-toggleable__label fitted sk-toggleable__label-arrow"><div><div>best_estimator_: RandomForestClassifier</div></div></label><div class="sk-toggleable__content fitted"><pre>RandomForestClassifier(max_features=3, n_estimators=300)</pre></div> </div></div><div class="sk-serial"><div class="sk-item"><div class="sk-estimator fitted sk-toggleable"><input class="sk-toggleable__control sk-hidden--visually" id="sk-estimator-id-4" type="checkbox" ><label for="sk-estimator-id-4" class="sk-toggleable__label fitted sk-toggleable__label-arrow"><div><div>RandomForestClassifier</div></div><div><a class="sk-estimator-doc-link fitted" rel="noreferrer" target="_blank" href="https://scikit-learn.org/1.6/modules/generated/sklearn.ensemble.RandomForestClassifier.html">?<span>Documentation for RandomForestClassifier</span></a></div></label><div class="sk-toggleable__content fitted"><pre>RandomForestClassifier(max_features=3, n_estimators=300)</pre></div> </div></div></div></div></div></div></div></div></div>
...
```
    ...
    [CV] END ..learning_rate=0.01, max_depth=9, n_estimators=200; total time=   0.5s
    [CV] END ..learning_rate=0.01, max_depth=9, n_estimators=200; total time=   0.4s
    [CV] END ..learning_rate=0.01, max_depth=9, n_estimators=300; total time=   0.6s
    [CV] END ..learning_rate=0.01, max_depth=9, n_estimators=300; total time=   0.8s
    [CV] END ..learning_rate=0.01, max_depth=9, n_estimators=300; total time=   0.7s
    ...
    [CV] END .learning_rate=0.001, max_depth=6, n_estimators=100; total time=   0.4s
    ...
    [CV] END .learning_rate=0.001, max_depth=6, n_estimators=200; total time=   0.3s
    [CV] END .learning_rate=0.001, max_depth=6, n_estimators=200; total time=   0.2s
    [CV] END .learning_rate=0.001, max_depth=6, n_estimators=300; total time=   0.3s
    [CV] END .learning_rate=0.001, max_depth=6, n_estimators=300; total time=   0.2s
    [CV] END .learning_rate=0.001, max_depth=6, n_estimators=300; total time=   0.3s
    ...
    [CV] END .learning_rate=0.001, max_depth=9, n_estimators=200; total time=   0.3s
    [CV] END .learning_rate=0.001, max_depth=9, n_estimators=200; total time=   0.3s
    [CV] END .learning_rate=0.001, max_depth=9, n_estimators=300; total time=   0.6s
...
y8_pred_after_gs = best_xgb_model.predict(scaled_X8_test)

# Calculate MCC
mcc_after_gs = matthews_corrcoef(y8_test, y8_pred_after_gs)
print(f"MCC after Grid Search: {mcc_after_gs:.4f}")
```
